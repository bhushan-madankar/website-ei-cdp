...
const AdminPage = () => {
    ...
    return (
        <div className="p-6 bg-gray-100 min-h-screen">
            ...
            <button 
            onClick={update}
            className="px-4 py-2 ml-4 p-3 mt-4 bg-green-500 text-white hover:bg-green-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                Update
            </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                        ...
                        >
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex space-x-4">
                                    ...
                                    <select
                                        className={`px-3 py-2 rounded-lg ${item.approved ? 'bg-green-500 text-white' : 'bg-red-500 text-white'}`}
                ...
                <div className="col-span-1 md:{col-span-1 min-h-[30vh] max-h-[65vh]  }  min-h-[10vh] ">
